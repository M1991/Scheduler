namespace Scheduler.Migrations
{
    ...
    public partial class _InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ScheduleddateofDelivery = c.DateTime(nullable: false),
                        RescDated = c.DateTime(nullable: false),
                ...
                c => new
                    {
                        ...
                        incr = c.Int(nullable: false),
                        Hdate = c.DateTime(nullable: false),
                        HName = c.String(),
                        HDesc = c.String(),
                    })
                .PrimaryKey(t => t.iId);
                ...
                c => new
                    {
                        ...
                        devDate = c.DateTime(nullable: false),
                        nwStatn = c.String(),
                        lastEvCnt = c.Int(nullable: false),
                        evLsono = c.String(),
                    })
                .PrimaryKey(t => t.uid);
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.Roles");
            DropTable("dbo.notf_access");
            DropTable("dbo.UsersInfo");
            DropTable("dbo.UserRoles");
            DropTable("dbo.UserLogins");
            DropTable("dbo.UserClaims");
            DropTable("dbo.Users");
            DropTable("dbo.HolidayTable");
